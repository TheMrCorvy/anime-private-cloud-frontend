...
const SignInTicket: FC<Props> = ({ isRegisterForm, registerToken, error }) => {
	return (
		...
		>
			...
			<div className={`bg-slate-800 absolute h-12 w-12 rounded-3xl ${!isRegisterForm ? 'top-[49%]' : 'top-[40%]'} lg:top-[-1.5rem] -left-[1.5rem] lg:left-[48.4%]`}></div>
			<div className={`bg-slate-800 absolute h-12 w-12 rounded-3xl ${!isRegisterForm ? 'bottom-[25%]' : 'bottom-[35%]'} lg:bottom-[-1.5rem] -left-[1.5rem] lg:left-[48.4%]`}></div>
			...
			<div className={`bg-slate-800 absolute h-12 w-12 rounded-3xl ${!isRegisterForm ? 'bottom-[25%]' : 'bottom-[35%]'} lg:bottom-[-1.5rem] -right-[1.5rem] lg:left-[65%]`}></div>
			<div className={`bg-slate-800 absolute h-12 w-12 rounded-3xl ${!isRegisterForm ? 'top-[49%]' : 'top-[40%]'} lg:top-[-1.5rem] -right-[1.5rem] lg:left-[65%]`}></div>
		</section>
	);
};
